...
// const gb = `url(${import.meta.env.BASE_URL}/img/language/gb.png)`;
// const fr = `url(${import.meta.env.BASE_URL}/img/language/fr.png)`;
// const de = `url(${import.meta.env.BASE_URL}/img/language/de.png)`;
// import gb from "/img/language/gb.png";
// import fr from "/img/language/fr.png";
// import de from "/img/language/de.png";
const gb = `${import.meta.env.BASE_URL}img/language/gb.png`; // output: /img/logo/Logo.svg
const fr = `${import.meta.env.BASE_URL}img/language/fr.png`;
const de = `${import.meta.env.BASE_URL}img/language/de.png`;

// const gb = `/img/language/gb.png`;
// const fr = `/img/language/fr.png`;
