...
// const gb = `./assets/img/language/gb.png`;
// const fr = `./assets/img/language/fr.png`;
// const de = `./assets/img/language/de.png`;
import gb from "@/assets/img/language/gb.png";
import fr from "@/assets/img/language/fr.png";
import de from "@/assets/img/language/de.png";
...
const TopbarLanguage = () => {
    ...
    return (
        <TopbarLanguageCollapse>
            ...
            <TopbarLanguageCollapseContent isCollapsed={isCollapsed}>
                <h1>Text</h1>
...
const TopbarLanguageCollapseContent = styled.div`
    max-height: ${({ isCollapsed }) => (isCollapsed ? "200px" : "0")};
    overflow: hidden;
