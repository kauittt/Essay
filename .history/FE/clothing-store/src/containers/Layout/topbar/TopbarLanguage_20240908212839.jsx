...
const gb = `${import.meta.env.PUBLIC_URL}/img/language/gb.png`;
const fr = `${import.meta.env.PUBLIC_URL}/img/language/fr.png`;
const de = `${import.meta.env.PUBLIC_URL}/img/language/de.png`;
