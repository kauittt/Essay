...
const gb = `${import.meta.env.BASE_URL}img/logo/Logo2.svg`; // output: /img/logo/Logo.svg
const fr = `${import.meta.env.BASE_URL}img/logo/Logo2.svg`;
const de = `${import.meta.env.BASE_URL}img/logo/Logo2.svg`;
