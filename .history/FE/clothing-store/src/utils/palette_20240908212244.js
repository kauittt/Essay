...
export const logoImg = theme("mode", {
    light: `url(${import.meta.env.PUBLIC_URL}img/logo/logo_light.svg)`,
    dark: `url(${import.meta.env.PUBLIC_URL}img/logo/logo_dark.svg)`,
});
...
export const colorDarkRed = "#ff4861";
