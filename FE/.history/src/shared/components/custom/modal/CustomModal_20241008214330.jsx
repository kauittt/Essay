...
import CustomerModal from "../../../../containers/Customer/modal/CustomerModal";
import UserModal from "../../../../containers/User/modal/UserModal";
import ItemModal from "../../../../containers/Item/modal/ItemModal";
import SaleQuoteModal from "../../../../containers/Sale/SaleQuote/modal/SaleQuoteModal";
...
const StyledModal = styled(BootstrapModal).withConfig({
    ...
    .modal-dialog {
        ...
        align-items: center;
        justify-content: center;
        max-width: 98%; //! Adjust this to set the new width of the modal
