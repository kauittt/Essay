            ...
            {headerGroups.map((headerGroup) => (
                ...
                >
                    {headerGroup.headers.map((column) => {
                        const { key, ...rest } = column.getHeaderProps(); //* Extract key from getHeaderProps
                        return (
                            <th
                                key={key}
                                {...rest} //* Spread the remaining props without key
                                {...rest.getHeaderProps(headerPropsSortable)}
                                {...rest.getHeaderProps(headerPropsResize)}
                            >
                                <Header
                                    column={column}
