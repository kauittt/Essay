                ...
                >
                    <PanelCardBody>
                        ...
                        <PanelCardHeader>
                            ...
                            <PanelButtons
                                isExtraBtn={extraPanelButton !== null}
                            >
                                <PanelButton
                                    type="button"
                                ...
                                <PanelButton type="button" onClick={onDismiss}>
                                    <CloseIcon />
                                </PanelButton>
                            </PanelButtons>
                            {extraPanelButton && (
                        ...
                        <Collapse in={collapse}>
                            <PanelContentWrapper>
                                ...
                                {panelFooter && (
                                    <PanelContent>{panelFooter}</PanelContent>
                                )}
                            </PanelContentWrapper>
                        </Collapse>
                    </PanelCardBody>
...
const PanelCard = styled(Card).withConfig({
    shouldForwardProp: (prop, defaultValidatorFn) =>
        !["collapse", "divider"].includes(prop) && defaultValidatorFn(prop),
})`
    transition: 0.3s;
